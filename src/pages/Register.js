        ...
        if (error === "False"){
            try{
                await axios.post("http://localhost:5000/Register", {
                    occupation, name, username, collagename, YearOfPassOut,emailid, phonenum, password, cnfpassword
                })
                .then(res=>{
            ...
            <form>
                <div className="Regisdata">
                    <div className="Roledropdown">
                        <select id="roledrpdwn" value={occupation} onChange={(event)=>setSelectedOption(event.target.value)}>
                    ...
                    <div className="regispers">
                        ...
                        <input id="usname" name="" onChange={(e)=> {setusname(e.target.value)}} type="text" placeholder="Username"/>
                    </div>
                    {(occupation === "Student") && <div className="regisqua">
                    ...
                    <div className="regissub" >
                        <input id="signup" type="submit" onClick={submit} style={{height:"40px"}}/>
                    </div>
                </div>
            </form>
        </div>
